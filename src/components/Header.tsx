...
import { Calendar, Sparkles, ExternalLink, Menu, X, ArrowUpRight, TrendingUp } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 pt-4 pb-2 transition-all duration-300">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          {/* Action CTAs (Meet with Ashley + View Google Cloud Latest Updates stacked below it) */}
          <div className="hidden sm:flex flex-col items-end gap-1.5">
            <a
              href={CONNECT_LINKS.meetAshley}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-2 px-4 py-1.5 rounded-2xl text-xs font-bold text-slate-900 bg-sky-200/85 hover:bg-sky-300/90 border border-sky-300/80 shadow-xs hover:shadow-md transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-1.5 px-3.5 py-1.5 rounded-2xl text-[11px] font-bold text-white bg-gradient-to-r from-sky-600 via-sky-500 to-blue-600 hover:from-sky-500 hover:to-blue-500 shadow-sm shadow-sky-500/20 hover:shadow-md transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
              <TrendingUp className="w-3 h-3 text-white shrink-0" />
              <span>View Google Cloud Latest Updates</span>
              <ExternalLink className="w-3 h-3 text-sky-100 shrink-0" />
            </a>
          </div>
          ...
          <div className="md:hidden pt-4 pb-2 border-t border-slate-100 mt-3 flex flex-col gap-2">
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-bold text-white bg-gradient-to-r from-sky-600 via-sky-500 to-blue-600"
              >

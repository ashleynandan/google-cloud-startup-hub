...
- **2026-09-17**: Updated site to reference **Gemini 3.8 Flash** pricing (`$0.75 / 1M input` & `$3.75 / 1M output` introductory pricing through Dec 31, 2026; `$0.375 / $1.875` Off-Peak PayGo) across the Model Matrix cards, Full Spec & Pricing Table, Engineering Recommendation, and API endpoints. Added an interactive **AI Strategy Priority Triangle** (`Raw Capability`, `Latency`, `Sovereignty`) asking *"What's Most Important to You?"* directly below *Understanding Google Cloud AI Strategy*.
